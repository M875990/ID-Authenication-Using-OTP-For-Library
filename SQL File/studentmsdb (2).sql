...
INSERT INTO `tblbook` (`ID`, `StudentName`, `StudentClass`, `Gender`, `StuID`, `StudentBranch`, `BookId`, `BookName`, `Bookauthor`, `Borrowdate`, `Duedate`, `ContactNumber`) VALUES
(6, 'MADHU K S', '8', 'Male', '4hg19cs018', 'CSE', 'G567', 'WEB', 'sumathi', '2023-04-19', '2023-05-19', 0),
(7, 'sumathi', '1', 'Male', '4HG20CS027', 'CSE', 'G567', 'WEB', 'sumathi', NULL, '2023-12-31', 0),
(10, 'Keerthana', '8', 'Female', '4HG19CS016', 'CSE', 'k658', 'Unix', 'gvytfv ', '2023-05-06', '2023-06-06', 2147483647);
...
(10, 'Harshitha H R', 'harshithahr056@gmail.com', 'Female', '1994-03-14', '4HG21CS112', 8965412368, 9874563214, 'Hassan', '4HG21CS112', '4b19b3f2d622f95aae2e0ea1c8b98816', 'c3836acf068a9b227834e0adda226ac21682853922.jpg', '2023-04-30 11:25:22', 'CSE');
...
CREATE TABLE IF NOT EXISTS `tblfacultybook` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `FacultyName` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `Gender` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `FacultyID` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `Branch` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `BookId` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `BookName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `Bookauthor` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `Borrowdate` date DEFAULT NULL,
...
INSERT INTO `tblfacultybook` (`ID`, `FacultyName`, `Gender`, `FacultyID`, `Branch`, `BookId`, `BookName`, `Bookauthor`, `Borrowdate`, `Duedate`, `ContactNumber`) VALUES
(10, 'Harshitha H R', 'Female', '4HG21CS112', 'CSE', 'H987', 'UNIX', 'Robert james', '2023-04-30', '2023-05-30', NULL),
(9, 'Dr.Raghu M E', 'Male', '4hg22cs018', 'CSE', 'H879', 'System software', 'raghu', '2023-04-29', '2023-05-29', NULL),
(11, 'Madhuri', 'Female', '4HG21CS113', 'CSE', 'B542', 'WEB', 'raghu', '2023-05-06', '2023-06-06', NULL);
