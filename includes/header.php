    ...
    <div class="header" id="home">
      <nav class="navbar navbar-default">
        <div class="container">
          ...
          <a class="navbar-brand" href="index.php" style="margin-left: -100%; "><h4><b>ID AUTHENICATION USING OTP FOR LIBRARY</b></h4></a>
          </div>
          <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
              <ul class="nav navbar-nav navbar-right margin-top cl-effect-2">
                ...
                <li><a href="admin/login.php"><span data-hover="admin">Admin</span></a></li>
                <li><a href="faculty/login.php"><span data-hover="faculty">Faculty</span></a></li>
