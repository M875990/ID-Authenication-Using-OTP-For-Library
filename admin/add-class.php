        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Add Sem </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Add Sem</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Add Sem</h4>
                   ...
                   <!--     <select  name="section" class="form-control" required='true'>
                          ...
                          <option value="A">1 sem</option>
                          <option value="B">2 sem</option>
                          <option value="C">3 sem</option>
                          <option value="D">4 sem</option>
                          <option value="E">5 sem</option>
                          <option value="F">6 sem</option>
                          <option value="E">7 sem</option>
                          <option value="F">8 sem</option>
                        </select>-->
                      </div>
