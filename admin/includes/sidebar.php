...
{               ?>
          ...
          <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                <span class="menu-title">Facultys</span>
                <i class="icon-people menu-icon"></i>
              </a>
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add-faculty.php">Add Facultys</a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage-faculty.php">Manage Facultys</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
           ...
           <!-- <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#ui-basic2" aria-expanded="false" aria-controls="ui-basic2">
                <span class="menu-title">Student Book Details</span>
                <i class="fas fa-book-open menu-icon"></i>
              </a>
              <div class="collapse" id="ui-basic2">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="Add_Book_Details.php">Add Book Details</a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage_book_details.php">Manage Book Details</a></li>
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#ui-basic3" aria-expanded="false" aria-controls="ui-basic3">
                <span class="menu-title">Faculty Book Details</span>
                <i class="fas fa-book-open menu-icon"></i>
              </a>
              <div class="collapse" id="ui-basic3">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add-facultybook.php">Add Book Details</a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage-facultybook.php">Manage Book Details</a></li>
