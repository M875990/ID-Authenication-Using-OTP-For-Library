...
?>
                    ...
                    <div class=" col-md -6 col-xl report-inner-card">
                        <div class="inner-card-text">
                           <?php 
                        $sql1 ="SELECT * from  tblfaculty";
$query1 = $dbh -> prepare($sql1);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totclass=$query1->rowCount();
?>
                          <span class="report-title">Totak Facultys</span>
                          <h4><?php echo htmlentities($totclass);?></h4>
                          <a href="manage-faculty.php"><span class="report-count"> View Facultys</span></a>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <?php 
                        $sql2 ="SELECT * from  tblbook";
$query2 = $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$totstu=$query2->rowCount();
?>
                          <span class="report-title">Total Student Books</span>
                          <h4><?php echo htmlentities($totstu);?></h4>
                          <a href="manage_book_details.php"><span class="report-count"> View Books</span></a>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <?php 
                        $sql2 ="SELECT * from  tblfacultybook";
$query2 = $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$totstu=$query2->rowCount();
?>
                          <span class="report-title">Total Faculty Books</span>
                          <h4><?php echo htmlentities($totstu);?></h4>
                          <a href="manage-facultybook.php"><span class="report-count"> View Books</span></a>
                        </div>
                        <div class="inner-card-icon table-info">
                          <i class="icon-book-open"></i>
                        </div>
                      </div>
                <!--     <div class="col-md-6 col-xl report-inner-card">
