...
$sql="SELECT tblfaculty.FacultyID,tblfaculty.ID as sid, tblfaculty.Branch,tblfaculty.FacultyName,tblfaculty.FacultyEmail,tblfaculty.registrationDate from tblfaculty LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
//whisch color is better for background for photos
...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div><a href="edit-facultys.php?editid=<?php echo htmlentities ($row->sid);?>"><i class="icon-eye"></i></a>
                                                || <a href="manage-faculty.php?delid=<?php echo ($row->sid);?>" onclick="return confirm('Do you really want to Delete ?');"> <i class="icon-trash"></i></a></div>
                            </td> 
                          </tr><?php $cnt=$cnt+1;}} ?>
                        </tbody>
                      </table>
