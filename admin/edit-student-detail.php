...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $eid=$_GET['editid'];
$sql="update tblstudent set StudentName=:stuname,StudentEmail=:stuemail,StudentBranch=:stubranch,StudentClass=:stuclass,Gender=:gender,DOB=:dob,StuID=:stuid,ContactNumber=:connum,AltenateNumber=:altconnum,Address=:address where ID=:eid";
