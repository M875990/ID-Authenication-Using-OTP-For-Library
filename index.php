...
<div class="slider">
   ...
   <div class="container-fluid bg-light"> 
    <div class="row">
      <div class="col-sm-12" >
        <h1 style=" color: #000; font-family: cursive;" class="text-center mt-4" >Welcome to  GECM Library</h1>
        <img src="images/govt2.jpg" class="img-fluid mx-auto d-block mt-4" style="width:100%; height:100%">
      </div>
    </div>
   </div> 
