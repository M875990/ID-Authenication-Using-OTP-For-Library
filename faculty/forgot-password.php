...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT FacultyEmail FROM tblbook WHERE FacultyEmail=:email and ContactNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblfaculty set Password=:newpassword where FacultyEmail=:email and ContactNumber=:mobile";
